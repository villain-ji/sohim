...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/villain-ji/sohim",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/shubho_timeline")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+vYPjZgYy64M4NjA1")
